      ...
      case 0:
        switch (character2) {
          ...
          case 59:
            characters2 += ";";
          default:
            append(reference = ruleset(characters2, root, parent, index2, offset, rules, points, type3, props = [], children = [], length2), rulesets);
            if (character2 === 123)
              if (offset === 0)
...
function ruleset(value, root, parent, index2, offset, rules, points, type3, props, children, length2) {
  var post = offset - 1;
  ...
  for (var i = 0, j = 0, k2 = 0; i < index2; ++i)
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j = points[i])), z2 = value; x2 < size; ++x2)
      if (z2 = trim(j > 0 ? rule[x2] + " " + y2 : replace(y2, /&\f/g, rule[x2])))
        props[k2++] = z2;
  return node(value, root, parent, offset === 0 ? RULESET : type3, props, children, length2);
}
...
var createEmotionProps = function createEmotionProps2(type3, props) {
  var newProps = {};
...
function jsx(type3, props, key) {
  if (!hasOwnProperty.call(props, "css")) {
    return jsx$1(type3, props, key);
  }
  return jsx$1(Emotion, createEmotionProps(type3, props), key);
}
function jsxs(type3, props, key) {
  if (!hasOwnProperty.call(props, "css")) {
    return jsxs$1(type3, props, key);
  }
...
const is$3 = typeof Object.is === "function" ? Object.is : isPolyfill;
const {
  useState,
  useEffect,
  useLayoutEffect,
...
function checkIfSnapshotChanged(inst) {
  ...
  try {
    ...
    return !is$3(prevValue, nextValue);
  } catch (error) {
    return true;
  }
}
...
const _xall$1 = _xall;
var all$1 = /* @__PURE__ */ _curry2(
  /* @__PURE__ */ _dispatchable(["all"], _xall$1, function all(fn, list) {
    var idx = 0;
...
var _isArguments = /* @__PURE__ */ function() {
  return toString$3.call(arguments) === "[object Arguments]" ? function _isArguments2(x2) {
    return toString$3.call(x2) === "[object Arguments]";
...
const keys$2 = keys$1;
var map$1 = /* @__PURE__ */ _curry2(
  /* @__PURE__ */ _dispatchable(["fantasy-land/map", "map"], _xmap$1, function map(fn, functor) {
...
const values$2 = values$1;
var type$1 = /* @__PURE__ */ _curry1(function type(val) {
...
var equals$1 = /* @__PURE__ */ _curry2(function equals(a, b2) {
  return _equals(a, b2, [], []);
});
const equals$2 = equals$1;
...
const last$2 = last$1;
var or$1 = /* @__PURE__ */ _curry2(function or(a, b2) {
  return a || b2;
});
const or$2 = or$1;
...
var find$1 = /* @__PURE__ */ _curry2(
  /* @__PURE__ */ _dispatchable(["find"], _xfind$1, function find(fn, list) {
    var idx = 0;
    var len = list.length;
    while (idx < len) {
      if (fn(list[idx])) {
...
var findIndex$1 = /* @__PURE__ */ _curry2(
  /* @__PURE__ */ _dispatchable([], _xfindIndex$1, function findIndex(fn, list) {
    var idx = 0;
    var len = list.length;
    while (idx < len) {
      if (fn(list[idx])) {
...
var _xuniqBy = /* @__PURE__ */ _curry2(function _xuniqBy2(f2, xf2) {
  return new XUniqBy(f2, xf2);
});
const _xuniqBy$1 = _xuniqBy;
var uniqBy = /* @__PURE__ */ _curry2(
  /* @__PURE__ */ _dispatchable([], _xuniqBy$1, function(fn, list) {
    var set = new _Set$1();
    var result = [];
    var idx = 0;
...
const uniq$1 = uniq;
var intersection$1 = /* @__PURE__ */ _curry2(function intersection(list1, list2) {
...
const intersection$2 = intersection$1;
...
var mergeDeepRight$1 = /* @__PURE__ */ _curry2(function mergeDeepRight(lObj, rObj) {
  return mergeDeepWithKey$1(function(k2, lVal, rVal) {
    return rVal;
  }, lObj, rObj);
});
const mergeDeepRight$2 = mergeDeepRight$1;
...
const where$1 = where;
var whereEq$1 = /* @__PURE__ */ _curry2(function whereEq(spec, testObj) {
  return where$1(map$2(equals$2, spec), testObj);
});
const whereEq$2 = whereEq$1;
var index = function(breakpoints) {
  ...
  function flatten(obj) {
    ...
    Object.keys(obj).forEach(function(key) {
      var item = obj[key];
      if (!Array.isArray(item) && literal)
        item = [item];
      if ((literal || Array.isArray(item)) && key.charCodeAt(0) !== 38) {
        var prior = void 0;
        item.forEach(function(v2, index2) {
          if (overlap && prior === v2) {
            return;
          }
          if (v2 == null) {
          ...
          if (index2 === 0 && !literal) {
            ...
            var _slots$mq$index;
            slots[mq[index2]] = (_slots$mq$index = {}, _slots$mq$index[key] = v2, _slots$mq$index);
          } else {
            slots[mq[index2]][key] = v2;
          }
        });
...
var newContext = function(_a) {
  var _b;
  var _c = _a.name, name = _c === void 0 ? "" : _c, initState = _a.initState, _d = _a.reducer, reducer2 = _d === void 0 ? function(_, d2) {
    return d2;
  } : _d;
  name = capitalized(name);
  var StateContext = react.exports.createContext(initState);
  var UpdaterContext = react.exports.createContext(function(s) {
    return s;
  });
  var Provider = function(_a2) {
    var _b2 = _a2.children, children = _b2 === void 0 ? null : _b2;
    var _c2 = react.exports.useReducer(reducer2, initState), store = _c2[0], setStore = _c2[1];
    return /* @__PURE__ */ jsx(StateContext.Provider, {
      value: store,
      children: /* @__PURE__ */ jsx(UpdaterContext.Provider, {
        value: setStore,
        children
      })
    });
  };
  var useState2 = function() {
    var storeState = react.exports.useContext(StateContext);
  ...
  var useUpdater = function() {
    var setStore = react.exports.useContext(UpdaterContext);
    if (typeof setStore === "undefined") {
      throw new Error("".concat(name, ".useUpdater must be used within a StoreProvider"));
    }
    var updater = react.exports.useCallback(setStore, [setStore]);
    return updater;
  };
  var context = (_b = {}, _b["".concat(name, "Provider")] = Provider, _b["use".concat(name, "State")] = useState2, _b["use".concat(name, "Updater")] = useUpdater, _b);
  return context;
};
var IS_SSR$1 = typeof document === "undefined";
if (IS_SSR$1) {
  React.useLayoutEffect = React.useEffect;
}
var useIsomorphicLayoutEffect$1 = React.useLayoutEffect;
...
var PRINT_TYPE;
(function(PRINT_TYPE2) {
  PRINT_TYPE2[PRINT_TYPE2["ERROR"] = 0] = "ERROR";
  PRINT_TYPE2[PRINT_TYPE2["ALERT"] = 1] = "ALERT";
  PRINT_TYPE2[PRINT_TYPE2["LOG"] = 2] = "LOG";
})(PRINT_TYPE || (PRINT_TYPE = {}));
var VERIFY;
(function(VERIFY2) {
  VERIFY2[VERIFY2["TY"] = 0] = "TY";
  VERIFY2[VERIFY2["TY_IN"] = 1] = "TY_IN";
  VERIFY2[VERIFY2["VALUES_TY_IN_ARR"] = 2] = "VALUES_TY_IN_ARR";
  VERIFY2[VERIFY2["KEYS_TY_IN_ARR"] = 3] = "KEYS_TY_IN_ARR";
  VERIFY2[VERIFY2["EQ"] = 4] = "EQ";
  VERIFY2[VERIFY2["KEYS_EQ_KEYS"] = 5] = "KEYS_EQ_KEYS";
  VERIFY2[VERIFY2["OBJ_IN_OBJ"] = 6] = "OBJ_IN_OBJ";
  VERIFY2[VERIFY2["WHERE_IN_ARR"] = 7] = "WHERE_IN_ARR";
  VERIFY2[VERIFY2["ARR_IN_ARR"] = 8] = "ARR_IN_ARR";
  VERIFY2[VERIFY2["KEYS_IN_KEYS"] = 9] = "KEYS_IN_KEYS";
  VERIFY2[VERIFY2["KEY_IN_ARR"] = 10] = "KEY_IN_ARR";
})(VERIFY || (VERIFY = {}));
var printVerifyMesage = function(printType, v2, expected, received) {
  var mesage = "Ups missing error rule.";
  if (v2 === VERIFY.TY)
    mesage = "This element: ".concat(toString2(received), " does not instead of ").concat(toString2(type2(expected())), ".");
  if (v2 === VERIFY.TY_IN || v2 === VERIFY.VALUES_TY_IN_ARR || v2 === VERIFY.KEYS_TY_IN_ARR)
    mesage = "This element: ".concat(toString2(received), " does not contain only ").concat(toString2(type2(expected())), "'.");
  if (v2 === VERIFY.EQ || v2 === VERIFY.KEYS_EQ_KEYS)
    mesage = "This element: ".concat(toString2(received), " does not match to schema: ").concat(toString2(expected), ".");
  if (v2 === VERIFY.OBJ_IN_OBJ || v2 === VERIFY.KEYS_IN_KEYS || v2 === VERIFY.KEY_IN_ARR || v2 === VERIFY.ARR_IN_ARR)
    mesage = "This element: ".concat(toString2(received), " is not included in the scheme: ").concat(toString2(expected), ".");
...
var verifyScheme = function(received, expected, v2, emptyMode, printType) {
  if (emptyMode === void 0) {
    emptyMode = false;
  }
  if (printType === void 0) {
    printType = PRINT_TYPE.ALERT;
  }
  if (emptyMode && (!received || !expected))
    return true;
  var pass = true;
  if (v2 === VERIFY.TY)
    pass = is2(expected, received);
  if (v2 === VERIFY.TY_IN)
    pass = all2(is2(expected))(received);
  if (v2 === VERIFY.VALUES_TY_IN_ARR)
    pass = all2(is2(expected))(values2(received));
  if (v2 === VERIFY.KEYS_TY_IN_ARR)
    pass = all2(is2(expected))(keys3(received));
  if (v2 === VERIFY.EQ)
    pass = equals2(expected, received);
  if (v2 === VERIFY.OBJ_IN_OBJ)
    pass = whereEq2(expected)(received);
  if (v2 === VERIFY.WHERE_IN_ARR)
    pass = all2(expected)(received);
  if (v2 === VERIFY.KEYS_EQ_KEYS)
    pass = equals2(expected, keys3(received));
  if (v2 === VERIFY.KEYS_IN_KEYS)
    pass = equals2(intersection2(keys3(expected), keys3(received)), keys3(received));
  if (v2 === VERIFY.ARR_IN_ARR)
    pass = equals2(intersection2(expected, received), received);
  if (v2 === VERIFY.KEY_IN_ARR)
    pass = includes(received)(expected);
  if (!pass)
    printVerifyMesage(printType, v2, expected, received);
  return pass;
};
...
var createMediaFlafs = function(bp, width) {
  return reduce(function(pre, key) {
    var _a;
    return mergeDeepRight2(pre, (_a = {}, _a[key] = bp[key] <= width, _a));
  }, {})(keys3(bp));
};
var useMediaFlags = function(bp, enable) {
  var bpValeus = values2(bp);
  var initLimitMax = function() {
    var borderMax = or2(last(bpValeus), 0);
    var width = getLayout().width;
    if (width >= borderMax)
      return borderMax;
    var limitMaxOn = find2(function(v2) {
      return width <= v2;
    })(bpValeus);
    return or2(limitMaxOn, 0);
  }();
  var _a = react.exports.useState(initLimitMax), limitMax = _a[0], setLimitMax = _a[1];
  var limitMaxIndex = findIndex2(equals2(limitMax))(bpValeus);
  useIsomorphicLayoutEffect(function() {
    if (enable) {
      ...
      return function() {
        return window.removeEventListener("resize", updateLayout_1);
      };
    }
    return function() {
    };
...
var createMediaQueries = function(brakePoints) {
  return reduce(function(pre, key) {
    var _a;
    return mergeDeepRight2(pre, (_a = {}, _a[key] = "@media (min-width: ".concat(brakePoints[key], "px)"), _a));
  }, {})(keys3(brakePoints));
};
var getInitConfig = function(init) {
  ...
  var scheme = mergeDeepRight2(emptyScheme, baseScheme);
  ...
  var themes = init.themes || empty.themes;
  map2(function(x2) {
    verifyScheme(x2.name, scheme.name, VERIFY.KEY_IN_ARR, true);
    verifyScheme(x2.tags, scheme.tags, VERIFY.ARR_IN_ARR, true);
    verifyScheme(x2.colors, scheme.colors, VERIFY.KEYS_EQ_KEYS, true);
    verifyScheme(x2.fontFamily, scheme.fontFamily, VERIFY.KEYS_EQ_KEYS, true);
    verifyScheme(x2.name, String, VERIFY.TY);
    verifyScheme(x2.tags, String, VERIFY.VALUES_TY_IN_ARR);
    verifyScheme(x2.colors, String, VERIFY.VALUES_TY_IN_ARR);
...
var reducer = function(data2, _a) {
  var action = _a[0], payload = _a[1];
  if (action === Actions.GUIDE)
    return payload;
  if (action === Actions.THEME)
    return __assign(__assign({}, data2), {
      theme: find2(function(_a2) {
        var name = _a2.name;
        return equals2(name, payload);
      })(data2.themes)
    });
  return data2;
};
...
var createStyleGuide = function(config) {
  ...
  var useStyleGuide2 = function(refreshLevel) {
    ...
    var mediaFlags = useMediaFlags(base.breakPoints, refreshLevel === 1);
    var dynamicHelpers = react.exports.useMemo(function() {
    ...
    var themeState = react.exports.useMemo(function() {
      var themesFlags = reduce(function(pre, _a2) {
        var _b;
        var name = _a2.name;
        return mergeDeepRight2(pre, (_b = {}, _b[name] = name === base.theme.name, _b));
      }, {})(base.themes);
      var tagsFlags = reduce(function(pre, _a2) {
        var tags = _a2.tags;
        var inners = reduce(function(pre2, tag) {
          var _a3;
          return mergeDeepRight2(pre2, (_a3 = {}, _a3[tag] = includes(tag)(base.theme.tags), _a3));
        }, {})(tags);
        return mergeDeepRight2(pre, inners);
      }, {})(base.themes);
      return {
        themesFlags,
        tagsFlags
    ...
    var fullGuide = react.exports.useMemo(function() {
      return __assign(__assign({}, base), {
        state: __assign(__assign({}, themeState), {
          mediaFlags
        }),
        helpers: __assign(__assign({}, base.helpers), dynamicHelpers)
      });
...
const SimplePage = ({
  ...
  react.exports.useEffect(() => {
    var _a;
    const IS_SSR2 = typeof document === "undefined";
    if (!IS_SSR2)
      (_a = document == null ? void 0 : document.querySelector("body")) == null ? void 0 : _a.style.setProperty("--bodyColor", rootBgColor);
    return () => {
    };
  }, [rootBgColor]);
...
const Button = ({
  ...
  return /* @__PURE__ */ jsxs("button", {
    css: styles.box,
    onClick,
    children: [right, title, children, left]
  });
};
const Tag = ({
  title = "",
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("main", {
      ...
      children: [/* @__PURE__ */ jsxs("p", {
        css: css2.counter,
        children: [`${index2 + 1}`, /* @__PURE__ */ jsx("small", {
          children: `/${total}`
        })]
      }), /* @__PURE__ */ jsx("h3", {
        css: css2.title,
        ...
        css: css2.tags,
        children: tags.map((tag) => /* @__PURE__ */ jsx(Tag, {
          title: tag
        }, tag))
      }), /* @__PURE__ */ jsx("p", {
        css: css2.resume,
...
const Main = () => {
  return /* @__PURE__ */ jsx(SimplePage, {
    children: /* @__PURE__ */ jsxs(Elements, {
      children: [/* @__PURE__ */ jsx(WarningWork, {}), /* @__PURE__ */ jsx(Hero, {}), /* @__PURE__ */ jsx(Proyects, {}), /* @__PURE__ */ jsx(Stack, {}), /* @__PURE__ */ jsx(History, {}), /* @__PURE__ */ jsx(Contact, {}), /* @__PURE__ */ jsx(Fotter, {})]
    })
  });
};
const App = () => {
  return /* @__PURE__ */ jsx(StyleGuideProvider, {
    children: /* @__PURE__ */ jsx(Main, {})
  });
};
const container = document.getElementById("app");
const missingApp = !(container == null ? void 0 : container.innerText);
const FullApp = () => {
